...
namespace LastFrontierApi.Services
{
  public class PlayerService : IPlayerService
  {
    ...
    public async Task<Player> CreatePlayerFromEmail(string email)
    {
      ...
      if (!playerResult.Succeeded) throw new Exception("Make this exception better :(");
    ...
    public async Task DeletePlayer(Player player)
    {
      ...
      if (!deletePlayerResult.Succeeded) throw new Exception("Make this exception better :(");
    }
